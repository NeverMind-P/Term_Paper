  ...
  return (
    <>
      <Meta
        ...
        description="A Full Stack Developer who passionate about modern web technology using React JS, TypeScript, and other JS Framework. And would be a fast learner to doing new things and build good teamwork either."
      />
      ...
      <Section background="teal" first>
        <div className="container mx-auto flex h-full max-w-screen-lg flex-col items-center justify-center px-4 text-center md:px-8 lg:px-12">
          ...
          <h1 className="title-front text-5xl font-black md:text-6xl lg:text-7xl">
            Oleksandr Boiko
          </h1>

          <p className="mt-4 text-sm font-medium text-gray-800 md:text-base lg:text-lg">
            A Full Stack Developer who passionate about modern web technology using React JS,
            TypeScript, and other JS Framework. And would be a fast learner to doing new things and
            build good teamwork either.
          </p>
        </div>
      </Section>
